...
# CSS para eliminar márgenes y mejorar vista en móvil
st.markdown("""
    <style>
    .block-container {
...
def check_password():
    ...
    if "password_correct" not in st.session_state:
        ...
        st.text_input("Introduce la contraseña para ver las finanzas:", 
                     type="password", on_change=password_entered, key="password")
        return False
    elif not st.session_state["password_correct"]:
        # Si falló la contraseña
        st.title("🔒 Acceso Privado")
        st.text_input("Contraseña incorrecta. Intenta de nuevo:", 
                     type="password", on_change=password_entered, key="password")
...
# --- SOLO SI PASA EL LOGIN, EJECUTAMOS EL RESTO ---
if check_password():
